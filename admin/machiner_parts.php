...
if (isset($_GET['part_id'])) {
  ...
  <div class="row form-group">
    ...
    <div class="col-sm-3">
        ...
        <select tabindex="2" name="part_maker" onchange="loadBrands(this.value)" id="part_maker" class="form-control abcCustomNew vehicle_maker" required="required">
          ...
          while($r = mysqli_fetch_assoc($q)): ?>
            ...
            <option <?=@($PartDe['part_maker']==$r['maker_id'])?"selected":""?> value="<?=$r['maker_id']?>"><?=$r['maker_name']?></option>
    ...
    <div class="col-sm-3">
        ...
        <select tabindex="3" name="part_brand" onchange="loadChassis(this.value)" id="vehicle_brand" class="form-control fuckJS vehicle_brand" required="required">
...
<div class="row">
  ...
  <div class="col-sm-3">
        ...
        <select  name="part_year" id="part_year" class="form-control part_reg_month" required="required" onchange="validateyears()">
          <option value="">~~SELECT~~</option>
          <?php
  ...
  <div class="col-sm-2">
        ...
        <select  name="part_manu_year" id="part_manu_year" class="form-control vehicle_reg_month" required="required" onchange="validateyears()">
        ...
        <datalist id="part_package1" >
          ...
          <option value="">~~SELECT~~</option>
            ...
            while($r = mysqli_fetch_assoc($q)): ?>
              ...
              <option <?=@($PartDe['part_package']==$r['pack_name'])?"selected":""?> value="<?=$r['pack_name']?>"><?=$r['pack_name']?></option>
  ...
  <div class="row">
    ...
    <div class="col-sm-3">
     ...
     <div class="col-sm-2">
        ...
        <input  value="<?=@$PartDe['part_steering']?>"  name="part_steering" id="part_steering" class="form-control" autocomplete="off">
    </div>
    <div class="col-sm-2">
        <label for="">Transmission</label>
        <input  value="<?=@$PartDe['part_transmission']?>" name="part_transmission" id="part_transmission" class="form-control" autocomplete="off">
    </div>
  </div><!-- mian -->
