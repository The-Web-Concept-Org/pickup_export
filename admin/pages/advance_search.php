      ...
      <div class="card" style="background-color: #efecec">
        ...
        <div class="card-body p-1" align="center">
          ...
          if ($stock_type=='stock') {
           ...
           @$query=mysqli_query($dbc,"SELECT * FROM vehicle_info LIMIT {$offsets},{$limit}");
           // print_r($query);
          }
          ...
          $sq="SELECT * FROM vehicle_info WHERE vehicle_status!='' ".$makerV." ".$brandV." ".$chasis_veh." ".$min_year." ".$colorV." ".$transmissionV." ".$optionsV." ".$min_price." ".$body_typeV." ".$fuelV." ".$stockidV." ".$eng_size." ".$eng_km." ".$load_cap." ".$eng_typ." ".$veh_disc." ";
           //echo $sq;
        ...
        <form method="get" style="padding: 0px 5px;" action="advance_search.php?type=stock">
            <div class="form-row">
              <div class="col-md-4 col-lg-2 col-sm">
                ...
                <select class="form-control select2-show-search border-bottom-0 w-100 br-3" data-placeholder="Select" name="maker" id="makers" required>
              ...
              <div class="col-md-4 col-lg-2 col-sm" style="">
                ...
                <div class="form-group">
                  <select class="form-control select2-show-search border-bottom-0 border-left-0 " data-placeholder="Select" name="color">
            ...
            <div class="form-row">
              <div class="col-md-6 col-lg-3 form-row" >
                ...
                <div class="col-md-6">
                  ...
                  <select name="options" id="options" class="form-control"  style="text-transform: uppercase ">
                    ...
                    <option value="<?=$st_r['option_name']?>" style="text-transform: uppercase!important;"><?=$st_r['option_name']?></option>
                    <?php endwhile ?>
                  </select>
                </div>
              ...
              <div class="col-md-6 col-lg-3">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="min_price">
                      <optgroup label="MIN">
                  ...
                  <div class="col-md-6">
                    <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="max_price">
                      <optgroup label="MAX">
              ...
              <div class="col-md-6 col-lg-3">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="from_engine">
                      <optgroup label="Type">
                  ...
                  <div class="col-md-6">
                    <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="to_engine">
                      <optgroup label="Type">
              ...
              <div class="col-md-2" style="">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-6">
                      <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="min_body_len">
                        <optgroup label="MIN">
                    ...
                    <div class="col-md-6">
                      <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="max_body_len">
                        <optgroup label="MAX">
              ...
              <div class="col-md-2" style="">
                ...
                <div class="form-group">
                  <div class="row">
                    <div class="col-md-6">
                      <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="min_load_capacity">
                        <optgroup label="MIN">
                    ...
                    <div class="col-md-6">
                      <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="max_load_capacity">
                        <optgroup label="MAX">
              ...
              <div class="col-md-2" style="">
                ...
                <div class="form-group">
                  <select class="form-control select2-show-search border-bottom-0 border-left-0 " data-placeholder="Select" name="engine_type">
              ...
              <div class="col-md-6 col-lg-3">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="min_disc">
                      <optgroup label="MIN">
                  ...
                  <div class="col-md-6">
                    <select class="form-control select2-show-search border-bottom-0 border-left-0 w-100" data-placeholder="Select" name="max_disc">
                      <optgroup label="MAX">
              ...
              <div class="col-md-2 pt-5" style="text-align: left">
                <div class="form-group">
                  <div class="form-check">
                    <button style="background-color: #55317E !important; color: #fff;" class="btn  btns mt-1" type="submit">
            ...
            <tr>
              ...
              <th>Action</th>
                ...
                <div class="center-block text-center pt-3">
                  <?php
                  $sql1=mysqli_query($dbc,"SELECT * FROM vehicle_info");
                  ...
                  <ul class="pagination mb-3 d-flex justify-content-center">
                    ...
                    if ($page>1) {
                    ?>
                    <li class="page-item"><a class="page-link " href="advance_search.php?type=stock&page=<?=$page-1?>">Pre</a></li>
                    <?php
                    } ?>
                    <?php
                    ...
                    ?>
                    <li class="page-item <?=$active?>"><a class="page-link ml-1 mr-1" href="advance_search.php?type=stock&page=<?= $i ?>"><?= $i ?></a></li>
                    <?php
                    }
                    ?>
                    <?php
                    if ($totalpage>=$page) {
                    ?>
                    <li class="page-item"><a class="page-link" href="advance_search.php?type=stock&page=<?=$page+1?>">Next</a></li>
                    <?php
                    }
                    ?>
                  </ul>
              ...
              <td align="center">
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownMenu3">
                    ...
                    <a href="vehicle_services.php?vehicle_id=<?=$r['vehicle_id']?>" class="dropdown-item"><i class="mr-1 fa fa-tasks"></i> Add Services</a>

                    <a href="vehicle_docs.php?vehicle_id=<?=$r['vehicle_id']?>" class="dropdown-item"><i class="mr-1 fa fa-plus-circle"></i> Add Documents</a>
                    <a href="crystal_report.php?v_id=<?=$r['vehicle_id']?>" class="dropdown-item"><i class="mr-1 fa fa-print"></i>Crystal Report</a>


                     <button id="myFunction" onclick="stats('vehicle_info','vehicle_id',<?=$r['vehicle_id']?>,'vehicle_sale_stts')" class="dropdown-item">
