...
<!-- start page content -->
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header card-bg" align="center"><h4>Create Seats</h4></div>
						<div class="card-body">
							<form action="php_action/custom_action.php" method="POST" role="form" id="formData">
								...
								<div class="form-group">
									...
									<select class="form-control" id="seats_sts" name="seats_sts"> 
...
<div class="col-sm-12">
		<div class="card">
	<div class="card-header card-bg" align="center"><h4>Seats</h4></div>
	<div class="card-body">
