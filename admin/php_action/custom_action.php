...
//update table column  = 'sold'  WHERE tableid = id 
	...
	if (isset($_REQUEST['column'])) {
		...
		$query = "UPDATE $tablename SET $column ='sold' WHERE $table_id = '$id'";
...
if (mysqli_num_rows($q)>0) {
	...
	if (isset($_POST['load_img_idMain']) && isset($_POST['load_img_idMain']) != "") {
	 	...
	 	$q = mysqli_query($dbc,"SELECT * FROM vehicle_images WHERE vehicle_id = $id AND images_type='".$_POST['image_type']."' ORDER BY order_no ASC" );
	...
	if (isset($_POST['tblName']) && isset($_POST['tblName']) != "") {
	 	...
	 	}elseif ($tblName == "machines") {



 	$q = mysqli_query($dbc,"SELECT machines.*, maker.*, brands.* FROM machines INNER JOIN maker ON machines.machine_maker = maker.maker_id INNER JOIN brands ON brands.brand_id = machines.machine_brand  WHERE machines.machine_id = $colID");

	 	}
	 	elseif ($tblName == "vehicle_parts") {



		 	$q = mysqli_query($dbc,"SELECT vehicle_parts.*, maker.*, brands.* FROM vehicle_parts INNER JOIN maker ON vehicle_parts.part_maker = maker.maker_id INNER JOIN brands
		 	 ON brands.brand_id = vehicle_parts.part_brand
		 	   WHERE vehicle_parts.part_id = $colID");

		 	// echo "SELECT vehicle_parts.*, maker.*, brands.* FROM machines INNER JOIN maker ON vehicle_parts.part_maker = maker.maker_id INNER JOIN brands
		 	//  ON brands.brand_id = vehicle_parts.part_brand
		 	//    WHERE vehicle_parts.part_id = $colID";
	        ...
	        $auction_grade_id = $row[0];
	            ...
	            if($row[2] == 1) {
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$auction_grade_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	     ...
	     $maker_sts = ""; 
	        ...
	        $maker_id = $row[0];
	            ...
	            if($row[2] == 1) {
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$maker_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
...
$button = '<!-- Single button -->
	...
	$btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$body_type_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
...
<input type="hidden" id="table_name" value="body_type"><input type="hidden" id="col_name" value="body_type_id"><input type="hidden" id="sts_col" value="body_type_sts"></form>';
	     ...
	     $color_code_sts = ""; 
	        ...
	        $color_code_id = $row[0];
	            ...
	            $color = '<h3 style="color: '.$row[2].'"><i class="fa fa-circle"></i></h3>';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$color_code_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	...
	$btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$cc_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	$button = '<!-- Single button -->
	...
	$btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$drive_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	     ...
	     $transmission_sts = ""; 
	        ...
	        $transmission_id = $row[0];
	            ...
	            if($row[2] == 1) {
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$transmission_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
...
$button = '<!-- Single button -->
	...
	$btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$interior_grade_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	     ...
	     $exterior_grade_sts = ""; 
	        ...
	        $exterior_grade_id = $row[0];
	            ...
	            $btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$exterior_grade_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	     ...
	     $seats_sts = ""; 
	        ...
	        $seats_id = $row[0];
	            ...
	            if($row[2] == 1) {
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$seats_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
...
$button = '<!-- Single button -->
	     ...
	     $doors_sts = ""; 
	        ...
	        $doors_id = $row[0];
	            ...
	            if($row[2] == 1) {
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$doors_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	     ...
	     $option_sts = ""; 
	        ...
	        $option_id = $row[0];
	            ...
	            if($row[2] == 1) {
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$option_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	     ...
	     $fuel_sts = ""; 
	        ...
	        $fuel_id = $row[0];
	            ...
	            if($row[2] == 1) {
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$fuel_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
				$button = '<!-- Single button -->
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $pack_sts = ""; 
	        ...
	        $pack_id = $row[0];
	            ...
	            <form><i id="'.$pack_id.'" class="fa fa-edit text-danger update" style="cursor: pointer;"></i> | <i id="'.$pack_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i><input type="hidden" id="table_name" value="package"><input type="hidden" id="col_name" value="pack_id"><input type="hidden" id="sts_col" value="pack_sts"></form>';
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $bidders_sts = ""; 
	        ...
	        $bidders_id = $row[0];
				...
				if ($userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$bidders_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	...
	$btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$auction_home_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
...
;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $consignee_sts = ""; 
	        ...
	        $consignee_id = $row[0];
				...
				if ($userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$consignee_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $inspection_company_sts = ""; 
	        ...
	        $inspection_company_id = $row[0];
				...
				if (@$userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$inspection_company_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $inspection_trans_sts = ""; 
	        ...
	        $inspection_trans_id = $row[0];
				...
				if (@$userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$inspection_trans_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	...
	$btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$transportation_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $services_company_sts = ""; 
	        ...
	        $services_company_id = $row[0];
				...
				if (@$userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$services_company_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $services_company_sts = ""; 
	        ...
	        $airmail_trans_id = $row[0];
				...
				if (@$userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$airmail_trans_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	...
	function vehicle_expense($dbc, $id){
	    ...
	    if($result->num_rows > 0) { 
	        ...
	        $btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$vehicle_expense_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	    ...
	    if($result->num_rows > 0) { 
	        ...
	        $reauction_id = $row[0];
	        	...
	        	$btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$reauction_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $customer_active = ""; 
	        ...
	        $customer_id = $row[0];
				...
				if ($userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$customer_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $country_regulation_sts = ""; 
	        ...
	        $country_regulation_id = $row[0];
				...
				if (@$userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$country_regulation_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
...
$button = '<!-- Single button -->
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $vehicle_feature_sts = ""; 
	        ...
	        $vehicle_feature_id = $row[0];
				...
				if (@$userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$vehicle_feature_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	...
	$btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$brand_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $model_sts = ""; 
	        ...
	        $model_id = $row[0];
	            ...
	            <form><i id="'.$model_id.'" class="fa fa-edit text-danger update" style="cursor: pointer;"></i> | <i id="'.$model_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i><input type="hidden" id="table_name" value="models"><input type="hidden" id="col_name" value="model_id"><input type="hidden" id="sts_col" value=""></form>';
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $shipper_sts = ""; 
	        ...
	        $shipper_id = $row[0];
				...
				if ($userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$shipper_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $shipment_company_sts = ""; 
	        ...
	        $shipment_company_id = $row[0];
				...
				if (@$userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$shipment_company_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $ricksu_company_sts = ""; 
	        ...
	        $ricksu_company_id = $row[0];
				...
				if ($userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$ricksu_company_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	     ...
	     $ricksu_company_sts = ""; 
	        ...
	        $ricksu_company_id = $row[1];
	          ...
	          $ricksu_company_name=fetchRecord($dbc,"ricksu_company","ricksu_company_id",$ricksu_company_id);
				...
				if (@$userPrivileges['nav_edit']==1 || $fetchedUserRole=="admin"): 
					$btn_del='| <i id="'.$row[0].'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
				endif;
	    ...
	    if($result->num_rows > 0) { 
	     ...
	     $auction_grade_sts = ""; 
	        ...
	        $btn_edit=$btn_del='';
					...
					if (@$userPrivileges['nav_delete']==1 || $fetchedUserRole=="admin"): 
						$btn_del='| <i id="'.$office_id.'" class="fe fe-trash-2 delete" style="cursor: pointer;"></i>';
					endif;
...
// foreach ($_FILES["file"]["name"] as $index => $value) { 	
    ...
    if(!empty($_FILES["file"]["name"])){ 
		...
		if ($_POST['images_get']=='ac') {

		$vehicle_id = $_POST['vehicle_id'];

        $stock_id = fetchRecord($dbc, "vehicle_info", "vehicle_id", $vehicle_id)['vehicle_stock_id'];

			 $q = mysqli_query($dbc,"INSERT INTO vehicle_images (vehicle_image_name, vehicle_id,images_type) VALUES ('$fileName', '$vehicle_id','vehicle')");

	// code...
		}elseif ($_POST['images_get']=='part') {
			
		$part_id = $_POST['part_id'];

        $stock_id ='';

			 $q = mysqli_query($dbc,"INSERT INTO vehicle_images (vehicle_image_name, vehicle_id,images_type) VALUES ('$fileName', '$part_id','part')");
		}elseif ($_POST['images_get']=='machine') {
			
		$part_id = $_POST['machine_id'];

        $stock_id ='';

			 $q = mysqli_query($dbc,"INSERT INTO vehicle_images (vehicle_image_name, vehicle_id,images_type) VALUES ('$fileName', '$part_id','machine')");
		}
