			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header card-bg " >
						<div class="row">
							<div class="col-sm-6">
								<h4 class="float-right text-white">Currency</h4>
							</div>
						

						<div  class="col-sm-6">
							<a href="currency.php" class="btn btn-sm btn-primary float-right">Add new</a>
						</div>
					</div>
					</div>
						<div class="card-body">
...
<div class="col-sm-12">
		<div class="card">
	<div class="card-header card-bg " align="center"><h4>Currency Lists</h4></div>
	<div class="card-body">
