...
<!-- start page content -->
          ...
          //echo "SELECT * FROM auction_person WHERE vehicle_id = '$id' AND trade_type='person'";
            ...
            <div class="tab-pane fade show active" id="vehicle_info2" role="tabpanel" aria-labelledby="veicle2-tab"> -->
              ...
              <div class="row <?=@$act?>">
                ...
                <div class="row <?=@$act?>">
                  ...
                  <input type="text" class="form-control" readonly="readonly" value="<?=@strtoupper($stock['vehicle_chassis_no'])?>">
