...
var custom_part_id = url.searchParams.get("part_id");

var custom_mchi_id = url.searchParams.get("machine_id");
 ...
 if (custom_part_id!=null || custom_mchi_id!=null) {
     setTimeout(function() {

                // $('#part_maker').trigger('change');
                 reloaded();
            },2000);
 }
        ...
        $.ajax({
            ...
            success:function(data) {       
                if (tbl == 'auction_grade') {
                    ...
                    $('#fuel_sts option[value="'+data.fuel_sts+'"]').prop("selected", true); 
                }else if (tbl == 'package') {
                    $("#pack_id").val(data.pack_id);
                    ("#pack_name").focus();
                    $("#pack_name").val(data.pack_name);
                    $('#pack_sts option[value="'+data.pack_sts+'"]').prop("selected", true); 
                }else if (tbl == 'bidders') {
...
function loadImageGallery(load_img_idMain,type='vehicle') {
    $.ajax({
        type: 'POST',
        url: 'php_action/custom_action.php',
        data:{load_img_idMain : load_img_idMain,image_type:type},
        dataType: 'json',
            beforeSend:function() {
                $(".loaderAjax").show(); 
            },
        ...
        <div class="container2">\
            <img width="200px" height="200px" style="margin:10px 10px;" src="img/vehicles_images/'+value['vehicle_image_name']+'">\
            <br>\
        ...
        success:function (res) {
                ...
                abc = '<table class="table table-hover">\
                          ...
                          <tbody>\
                            ...
                            <tr>\
                              ...
                              <td>'+msg[0].brand_name+'</td>\
                              <td>Type</td>\
                              <td>'+msg[0].machine_type+' KG</td>\
                            </tr>\
                             <tr>\
                              <td>Part no</td>\
                              <td>'+msg[0].part_no+'</td>\
                              <td>Machine weight</td>\
                              <td>'+msg[0].machine_weight+'</td>\
                            </tr>\
                            <tr>\
                              <td>Manufacture Year</td>\
                              <td>'+msg[0].machine_manu_year+'</td>\
                              <td>Machine year</td>\
                              <td>'+msg[0].machine_year+'</td>\
                            </tr>\
                            <tr>\
                              <td>Hours</td>\
                              <td>'+msg[0].machine_hours+'</td>\
                              <td>Length</td>\
                              <td>'+msg[0].machine_l+'</td>\
                            </tr>\
                            <tr>\
                              <td>Fuel</td>\
                              <td>'+msg[0].machine_fuel+'</td>\
                              <td>Height</td>\
                              <td>'+msg[0].machine_h+'</td>\
                            </tr>\
                            <tr>\
                              <td>Steering</td>\
                              <td>'+msg[0].machine_steering+'</td>\
                              <td>Width</td>\
                              <td>'+msg[0].machine_w+'</td>\
                            </tr>\
                            <tr>\
                              <td>Serial No</td>\
                              <td>'+msg[0].machine_serial_no+'</td>\
                              <td>Color</td>\
                              <td>'+msg[0].machine_color+'</td>\
                            </tr>\
                            <tr>\
                              <td>Note</td>\
                              <td>'+msg[0].machine_note+'</td>\
                              <td>Condition remarks</td>\
                              <td>'+msg[0].machine_condition_remarks+'</td>\
                            </tr>\
                            <tr>\
                              <td>Fob price</td>\
                              <td>'+msg[0].machine_fob_price+'</td>\
                              <td>Status</td>\
                              <td>'+msg[0].machine_sts+'</td>\
                            </tr>\
                            <tr>\
                              <td>Drive</td>\
                              <td>'+msg[0].machine_drive+'</td>\
                              <td>Transmission</td>\
                              <td>'+msg[0].machine_transmission+'</td>\
                            </tr>\
                            <tr>\
                              <td>Machine condition</td>\
                              <td>'+msg[0].machine_condition+'</td>\
                             \
                            </tr>\
                          </tbody>\
                        </table>';

                $(".modal-title").text('machines Data');
                $("#loadData").empty().append(abc);
                $('#modal-id').modal('show');
            }else if (tblName == 'vehicle_parts') {
                ...
                abc = '<table class="table table-hover">\
                          ...
                          <tbody>\
                            <tr>\
                              <td>Stock Id</td>\
                              <td>'+msg[0].part_stock_id+'</td>\
                              <td>Maker</td>\
                              <td>'+msg[0].maker_name+'</td>\
                            </tr>\
                            <tr>\
                              <td>Brand</td>\
                              <td>'+msg[0].brand_name+' KG</td>\
                             <td>Chassis No</td>\
                              <td>'+msg[0].part_chassis_no+'</td>\
                            </tr>\
                             <tr>\
                              <td>Part no.</td>\
                              <td>'+msg[0].part_no+'</td>\
                            ...
                            <tr>\
                              <td>Color</td>\
                              <td>'+msg[0].part_color+'</td>\
                              <td>Year</td>\
                              <td>'+msg[0].part_year+'</td>\
                            </tr>\
                            <tr>\
                              <td>Manufacture year</td>\
                              <td>'+msg[0].part_manu_year+'</td>\
                              <td>Package</td>\
                              <td>'+msg[0].part_package+'</td>\
                            </tr>\
                            <tr>\
                              <td>Km</td>\
                              <td>'+msg[0].part_km+'</td>\
                              <td>Fuel</td>\
                              <td>'+msg[0].part_fuel+'</td>\
                            </tr>\
                            <tr>\
                              <td>Fob price</td>\
                              <td>'+msg[0].part_fob_price+'</td>\
                              <td>Steering</td>\
                              <td>'+msg[0].part_steering+'</td>\
                            </tr>\
                            <tr>\
                              <td>Transmission</td>\
                              <td>'+msg[0].part_transmission+'</td>\
                              <td>Weight</td>\
                              <td>'+msg[0].part_weight+'</td>\
                            </tr>\
                            <tr>\
                              <td>Condition</td>\
                              <td>'+msg[0].part_condition_remarks+'</td>\
                              <td>Note</td>\
                              <td>'+msg[0].part_note+'</td>\
                            </tr>\
                            <tr>\
                              <td>Status</td>\
                              <td>'+msg[0].part_sts+'</td>\
                              <td>Parcel No</td>\
                              <td></td>\
                            </tr>\
                           \
                ...
                $(".modal-title").text('vehicle_parts Data');
                $("#loadData").empty().append(abc);
                $('#modal-id').modal('show');
            }
        }//success
