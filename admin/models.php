...
<!-- start page content -->
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header card-bg" align="center"><h4 class="text-white">Create Model</h4></div>
						<div class="card-body">
							<?php 
...
<div class="col-sm-12">
		<div class="card">
	<div class="card-header card-bg" align="center"><h4 class="text-white"> Model List</h4></div>
	<div class="card-body">
