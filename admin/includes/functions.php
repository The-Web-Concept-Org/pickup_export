...
function html_mailto($dbc,$id)

{

  $record=fetchRecord($dbc,"pending_inquiry","p_inquiry_id",$id);
  ...
  @$get_msg =mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM ceo_msg ORDER BY ceo_id DESC LIMIT 1"));
  $to_email=$record['inquiry_email'];
  
  $ComCeoMsg=@$get_msg['ceo_msg'];
  $ComAddress=@$get_company['address'];
  $ComPhone=@$get_company['company_phone'];
  $ComMail=@$get_company['email'];
  $ComLogo="https://htcjapan.jp/admin/img/logo/".@$get_company['logo'];
  $ComName=$subject=@$get_company['name'];
...
<h1 style="margin: 0; color: #ffffff; font-size: 46px; font-family: Georgia, Times, 'Times New Roman', serif; line-height: 120%; text-align: center; direction: ltr; font-weight: 700; letter-spacing: 3px; margin-top: 0; margin-bottom: 0;"><span class="tinyMce-placeholder">Hisso Trading LTD</span></h1>
</td>
</tr>
</table>
</td>
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #00bbdc; color: #000000;  background-position: top center; background-repeat: no-repeat; width: 640px;" width="640">
<tbody>
<tr>
...
<p style="margin: 0; font-size: 14px; text-align: center;"><span style="color:#ffffff;font-size:38px;"><strong>We're grateful</strong></span></p>
</div>
</div>
</td>
</tr>
...
<table border="0" cellpadding="0" cellspacing="0" class="text_block" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; word-break: break-word;" width="100%">
<tr>
<td style="padding-bottom:20px;padding-left:15px;padding-right:15px;">
<div style="font-family: sans-serif">
<div style="font-size: 12px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 14.399999999999999px; color: #555555; line-height: 1.2;">
<p style="margin: 0; font-size: 14px; text-align: center;"><span style="color:#ffffff;font-size:38px;"><strong>We received your inquiry!</strong></span></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 12px; text-align: center; mso-line-height-alt: 24px;"><span style="font-size:16px;"><span style="color:#ffffff;">We'll contact you Soon</span></span></p>
</div>
</div>
</td>
</tr>
...
<tr>
<td>
<table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content stack" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; background-color: #00bbdc; color: #000000; width: 640px;" width="640">
<tbody>
<tr>
...
<div style="font-family: sans-serif">
<div style="font-size: 12px; font-family: Nunito, Arial, Helvetica Neue, Helvetica, sans-serif; mso-line-height-alt: 18px; color: #555555; line-height: 1.5;">
<p style="margin: 0; font-size: 16px; text-align: center; mso-line-height-alt: 36px;"><span style="font-size:24px;color:#ffffff;"><strong>Our Customers are our biggest asset...</strong></span></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 22px; text-align: center;"><em><span style="font-size:16px;">`.$ComCeoMsg.`</span></em></p>
<p style="margin: 0; font-size: 22px; text-align: center;"><em><span style="font-size:16px;">– Ceo Company</span></em></p>
</div>
</div>
</td>
</tr>
...
<div align="center" style="line-height:10px"><a href="`.$ComURL.`" style="outline:none" tabindex="-1" target="_blank"><img alt="`.$ComName.`" src="`.$ComLogo.`" style="display: block; height: auto; border: 0; width: 170px; max-width: 100%;" title="`.$ComName.`" width="170"/></a></div>
</td>
</tr>
</table>
...
<p style="margin: 0; font-size: 14px; text-align: center;">`.$ComPhone.`<br/><a href="mailto:`.$ComMail.`" rel="noopener" style="text-decoration: underline; color: #ff8f05;" target="_blank" title="`.$ComMail.`">`.$ComMail.`</a></p>
<p style="margin: 0; font-size: 14px; text-align: center;">`.$ComAddress.`</p>
<p style="margin: 0; font-size: 14px; text-align: center;"><a href="`.$ComURL.`" rel="noopener" style="text-decoration: underline; color: #ff8f05;" target="_blank">www.htcjapan.jp.com</a></p>
</div>
</div>
</td>
</tr>
...
<p style="margin: 0; font-size: 14px; text-align: center;"><span style="font-size:11px;">This message is sent to you because your email address is on our subscribers list. If you are not interested in receiving more emails like this one, just hit <a href="`.$ComURL.`" rel="noopener" style="text-decoration: underline; color: #ff8f05;" target="_blank">UNSUBSCRIBE</a> or <a href="`.$ComURL.`" rel="noopener" style="text-decoration: underline; color: #ff8f05;" target="_blank">Manage your preferences</a>.</span></p>
<p style="margin: 0; font-size: 14px; text-align: center; mso-line-height-alt: 14.399999999999999px;"> </p>
<p style="margin: 0; font-size: 14px; text-align: center;"><span style="font-size:9px;">We are committed to guaranteeing the security and protection of the private information that we process. To understand more about how we collect, store, and process your personal information in compliance with GDPR, please take a look at our <a href="`.$ComURL.`" rel="noopener" style="text-decoration: underline; color: #ff8f05;" target="_blank">privacy policy</a>. </span><span style="font-size:9px;">©2022 [`.$ComName.`] </span></p>
</div>
</div>
</td>
</tr>
