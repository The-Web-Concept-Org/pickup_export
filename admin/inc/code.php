...
/*Add Channel*/
	...
	if (!empty($_REQUEST['user_edit_id'])) {
		...
		$users_button=' <button type="submit" id="budget_category" name="user_edit" data-loading-text="Loading..." class="btn btn-info pull pull-right"> Edit </button>';
	}else{
		$users_button=' <button type="submit" id="budget_category" name="users_add" data-loading-text="Loading..." class="btn btn-info pull pull-right"> Save </button>';
	}
	/*Edit budget Category*/
