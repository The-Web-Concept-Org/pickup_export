...
<!-- start page content -->
			...
			<div class="col-sm-12">
				<div class="card">
					<div class="card-header card-bg" align="center"><h4>Create Fuel Type</h4></div>
						<div class="card-body">
							<form action="php_action/custom_action.php" method="POST" role="form" id="formData">
								...
								<div class="form-group">
									...
									<select class="form-control" id="fuel_sts" name="fuel_sts"> 
...
<div class="col-sm-12">
		<div class="card">
	<div class="card-header card-bg" align="center"><h4>Fuel Type</h4></div>
	<div class="card-body">
			<table class="table" id="fuel">
				<thead>
			<tr>	
				<th>ID</th>
