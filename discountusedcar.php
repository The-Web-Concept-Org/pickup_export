		...
		<section class="sptb bg-patterns bg-white">
			<div class="container" >
				<div class="section-title center-block text-center">
					...
					<p style="font-size: 25px">Discount Used Cars</p>
				</div>
...
$brand = mysqli_fetch_assoc(mysqli_query($dbc,"SELECT * FROM brands WHERE brand_id = '$vehicle[vehicle_brand]'"));
					...
					<div class="item">
						<div class="card mb-0">
						    ...
						    ?>
							<div class="arrow-ribbon <?=$colorrib?>" style="font-size: 16px"><?=ucwords($vehicle['vehicle_mode'])?></div>
    ...
    white-space: nowrap;">
										    ...
										    <?=$maker['maker_name']?> <?=$brand['brand_name']?></h6></a>
									</div>
